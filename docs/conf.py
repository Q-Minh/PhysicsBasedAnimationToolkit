...
project = "Physics Based Animation Toolkit"
copyright = f'2024-{datetime.now().year}, Quoc-Minh Ton-That; MIT License'
...
html_theme_options = {
    ...
    "repo_url": "https://github.com/Q-Minh/PhysicsBasedAnimationToolkit",
    "repo_name": "Q-Minh/PhysicsBasedAnimationToolkit",
