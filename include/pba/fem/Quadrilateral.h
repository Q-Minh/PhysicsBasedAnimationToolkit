...
struct Quadrilateral<3>
{
    ...
    static int constexpr Dims  = 2;
    static int constexpr Nodes = 16;
    static std::array<int, Nodes * Dims> constexpr Coordinates =
        {0,0,1,0,2,0,3,0,0,1,1,1,2,1,3,1,0,2,1,2,2,2,3,2,0,3,1,3,2,3,3,3}; ///< Divide coordinates by Order to obtain actual coordinates in the reference element
