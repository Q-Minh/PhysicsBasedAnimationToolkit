...
template <class Derived>
std::tuple<Vector<1>, Matrix<1,1>>
StableNeoHookeanEnergy<1>::gradAndHessian(Eigen::DenseBase<Derived> const& F, Scalar mu, Scalar lambda) const
{
    Vector<1> G;
    Matrix<1,1> H;
    auto vecG = G.reshaped();
...
template <class Derived>
std::tuple<Vector<4>, Matrix<4,4>>
StableNeoHookeanEnergy<2>::gradAndHessian(Eigen::DenseBase<Derived> const& F, Scalar mu, Scalar lambda) const
{
    Vector<4> G;
    Matrix<4,4> H;
    auto vecG = G.reshaped();
...
template <class Derived>
std::tuple<Vector<9>, Matrix<9,9>>
StableNeoHookeanEnergy<3>::gradAndHessian(Eigen::DenseBase<Derived> const& F, Scalar mu, Scalar lambda) const
{
    Vector<9> G;
    Matrix<9,9> H;
    auto vecG = G.reshaped();
