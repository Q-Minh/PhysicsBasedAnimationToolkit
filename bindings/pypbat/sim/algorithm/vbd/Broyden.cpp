...
void BindBroyden(nanobind::module_& m)
{
    ...
    nb::class_<BroydenParams>(m, "BroydenParams")
        ...
        .def_rw("n_max_iters", &BroydenParams::nMaxIters, "Maximum number of Broyden iterations")
        .def_rw("k", &BroydenParams::k, "Current iteration")
    ...
    m.def(
        ...
        [](FemElastoDynamics<ElasticEnergyType>& fem,
           ...
           Params& params,
           BroydenParams& broyden) {
            pbat::sim::algorithm::vbd::Iterate<ElasticEnergyType>(fem, contact, params, broyden);
        },
        nb::arg("fem"),
        nb::arg("contact"),
        nb::arg("params"),
    ...
    m.def(
        ...
        [](FemElastoDynamics<ElasticEnergyType>& fem,
           ...
           Params& params,
           BroydenParams& broyden) {
            pbat::sim::algorithm::vbd::Solve<ElasticEnergyType>(fem, contact, params, broyden);
        },
        nb::arg("fem"),
        nb::arg("contact"),
        nb::arg("params"),
    ...
    m.def(
        ...
        [](FemElastoDynamics<ElasticEnergyType>& fem,
           ...
           Params& params,
           BroydenParams& broyden) {
            pbat::sim::algorithm::vbd::Integrate<ElasticEnergyType>(fem, contact, params, broyden);
        },
        nb::arg("fem"),
        nb::arg("contact"),
        nb::arg("params"),
