...
void BindAnderson(nanobind::module_& m)
{
    ...
    m.def(
        ...
        [](FemElastoDynamics<ElasticEnergyType>& fem,
           ...
           Params& params,
           AndersonParams& anderson) {
            pbat::sim::algorithm::vbd::Iterate<ElasticEnergyType>(fem, contact, params, anderson);
        },
        nb::arg("fem"),
        nb::arg("contact"),
        nb::arg("params"),
    ...
    m.def(
        ...
        [](FemElastoDynamics<ElasticEnergyType>& fem,
           ...
           Params& params,
           AndersonParams& anderson) {
            pbat::sim::algorithm::vbd::Solve<ElasticEnergyType>(fem, contact, params, anderson);
        },
        nb::arg("fem"),
        nb::arg("contact"),
        nb::arg("params"),
    ...
    m.def(
        ...
        [](FemElastoDynamics<ElasticEnergyType>& fem,
           ...
           Params& params,
           AndersonParams& anderson) {
            pbat::sim::algorithm::vbd::Integrate<ElasticEnergyType>(fem, contact, params, anderson);
        },
        nb::arg("fem"),
        nb::arg("contact"),
        nb::arg("params"),
