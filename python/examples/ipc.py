...
if __name__ == "__main__":
    ...
    # Lumped mass matrix
    rho = args.rho
    M = sp.sparse.diags(pbat.fem.lumped_mass_matrix(E, X, rho=rho, dims=dims, element=element, order=order))
    ...
    hep = HyperElasticPotential(E, X, eg, wg, GNegU, mug, lambdag,
                                energy=psi, spd_correction=spd_correction,
                                element=element, order=order, dims=dims)
    ...
    def callback():
        ...
        if animate or step:
            ...
            params = Parameters(E, X, x, v, a, M, hep, dt, cmesh,
