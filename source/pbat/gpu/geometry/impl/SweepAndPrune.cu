...
void RunSweepAndPruneTests()
{
    ...
    gpu::common::Buffer<GpuIndex, 2> EG(E1.cols());
    gpu::common::Buffer<GpuIndex, 3> FG(F2.cols());
    gpu::common::ToBuffer(V, VG);
    gpu::common::ToBuffer(E1, EG);
    gpu::common::ToBuffer(F2, FG);
    ...
    // Act
    gpu::common::SynchronizedList<OverlapType> overlaps(3 * overlapsExpected.size());
    gpu::geometry::impl::SweepAndPrune sap{};
    sap.SortAndSweep(
        aabbs,
