...
PBAT_HOST_DEVICE std::tuple<
    typename TMatrix::ScalarType,
    StableNeoHookeanEnergy<1>::SVector<typename TMatrix::ScalarType, 1>>
...
PBAT_HOST_DEVICE std::tuple<
    typename TMatrix::ScalarType,
    StableNeoHookeanEnergy<1>::SVector<typename TMatrix::ScalarType, 1>,
    StableNeoHookeanEnergy<1>::SMatrix<typename TMatrix::ScalarType, 1, 1>>
...
PBAT_HOST_DEVICE std::tuple<
    typename TMatrix::ScalarType,
    StableNeoHookeanEnergy<2>::SVector<typename TMatrix::ScalarType, 4>>
...
PBAT_HOST_DEVICE std::tuple<
    typename TMatrix::ScalarType,
    StableNeoHookeanEnergy<2>::SVector<typename TMatrix::ScalarType, 4>,
    StableNeoHookeanEnergy<2>::SMatrix<typename TMatrix::ScalarType, 4, 4>>
...
PBAT_HOST_DEVICE std::tuple<
    typename TMatrix::ScalarType,
    StableNeoHookeanEnergy<3>::SVector<typename TMatrix::ScalarType, 9>>
...
PBAT_HOST_DEVICE std::tuple<
    typename TMatrix::ScalarType,
    StableNeoHookeanEnergy<3>::SVector<typename TMatrix::ScalarType, 9>,
    StableNeoHookeanEnergy<3>::SMatrix<typename TMatrix::ScalarType, 9, 9>>
