...
struct Tetrahedron<3>
{
    ...
    [[maybe_unused]] static Matrix<kNodes, kDims> GradN([[maybe_unused]] Eigen::DenseBase<TDerived> const& X)
    {
        ...
        auto const a3 = (3.0/2.0)*X[1];
        auto const a4 = (3.0/2.0)*X[2];
        auto const a5 = a3 + a4;
        auto const a6 = -a2 - a5;
        auto const a7 = 3*X[1];
        auto const a8 = 3*X[2];
        auto const a9 = 3*X[0] - 2;
        auto const a10 = a7 + a8 + a9;
        auto const a11 = 3*a0*a6 + a10*a6 + a10*(-a1 - a5 + 3.0/2.0);
        auto const a12 = (9.0/2.0)*X[0];
        auto const a13 = (9.0/2.0)*X[1];
        auto const a14 = (9.0/2.0)*X[2];
        auto const a15 = a10*(a12 + a13 + a14 - 9.0/2.0);
        auto const a16 = (27.0/2.0)*X[0];
        auto const a17 = (27.0/2.0)*X[1];
        auto const a18 = (27.0/2.0)*X[2];
        auto const a19 = a16 + a17 + a18;
        auto const a20 = a19 - 27.0/2.0;
        auto const a21 = a19 - 9;
        auto const a22 = a20*X[0] + a21*X[0];
        auto const a23 = a16 - 9.0/2.0;
        auto const a24 = -a23;
        auto const a25 = a24*X[0];
        auto const a26 = -a20;
        auto const a27 = a20*X[1] + a21*X[1];
        auto const a28 = 27*X[0];
        auto const a29 = a28*X[1];
        auto const a30 = -a29;
        auto const a31 = 27*X[1];
        auto const a32 = -a28 - a31 - 27*X[2] + 27;
        auto const a33 = a32*X[1];
        auto const a34 = a16*X[1];
        auto const a35 = a17 - 9.0/2.0;
        auto const a36 = -a35;
        auto const a37 = a36*X[1];
        auto const a38 = a35*X[1];
        auto const a39 = a20*X[2] + a21*X[2];
        auto const a40 = a28*X[2];
        auto const a41 = -a40;
        auto const a42 = a32*X[2];
        auto const a43 = a16*X[2];
        auto const a44 = a31*X[2];
        auto const a45 = -a44;
        auto const a46 = a18 - 9.0/2.0;
        auto const a47 = -a46;
        auto const a48 = a47*X[2];
        auto const a49 = a46*X[2];
        auto const a50 = a32*X[0];
        auto const a51 = a23*X[0];
        auto const a52 = a17*X[2];
        GNp[0] = a11;
        GNp[1] = a15 + a22;
